<x-admin-layout>
    ...
    <div class="flex items-center justify-center p-12">
        ...
        <div class="mx-auto w-full max-w-[550px] bg-white">
            <form method="POST" action="{{route('admin.restaurantCategory.store')}}" enctype="multipart/form-data">
                @csrf
                <div class="mb-5">
                    <label
                        for="name"
                ...
                <div class="mb-5">
                    <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300" for="file_input">Upload Restaurant Category Picture</label>
