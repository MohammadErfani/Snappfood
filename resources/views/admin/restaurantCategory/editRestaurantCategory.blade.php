<x-admin-layout>
    ...
    <div class="flex items-center justify-center p-12">
        ...
        <div class="mx-auto w-full max-w-[550px] bg-white">
            <form method="POST" action="{{route('admin.restaurantCategory.update',$restaurantCategory->id)}}" enctype="multipart/form-data">
                @csrf
                @method('put')
                <div class="mb-5">
                    <label
                ...
                <div class="mb-3">
                    ...
                    <select name="parentCategory" id="parentCategory" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                        ...
                        @forelse($parentCategories as $parentCategory)
                            @if($parentCategory->id == $restaurantCategory->id)
                                @continue
                            @endif
                            {{$status = $parentCategory->id == $restaurantCategory->parent_category ? 'selected':''}}
                ...
                <div class="mb-5">
                    <img src="{{asset($restaurantCategory->picture)}}" class="w-56" alt="Doesn't have Picture">
